...
public final class barriosIndustriales_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  Modelo m = (Modelo) application.getAttribute("modelo");
    m.cargarTodosBarrio();
      ...
      out.write("                    ");
                        ...
                        int cont = 0;
                        for (Barrio per : p) {
                            if (per instanceof BIndustrial) {
                                BIndustrial temp = (BIndustrial) per;
                                cont++;
                                out.print("<tr>");

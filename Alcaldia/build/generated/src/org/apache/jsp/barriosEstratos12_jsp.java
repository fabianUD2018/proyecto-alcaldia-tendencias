...
public final class barriosEstratos12_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  Modelo m = (Modelo) application.getAttribute("modelo");
    m.cargarTodosBarrio();
      ...
      out.write("                        <th scope=\"col\">Rutas</th>\n");
      out.write("                    </tr>\n");
      out.write("                </thead>\n");
      out.write("                <tbody>\n");
      out.write("                    ");
                        ...
                        for (Barrio per : p) {
                            if (per instanceof BEstratoInferior) {
                                ...
                                for (int i = 0; i < temp.getM_Rutas().size(); i++) {
                                        rutas+= " "+temp.getM_Rutas().get(i).getDescripcion();
                                    }
                                out.print("<td>" + rutas + "</td>");
                                out.print("</tr>");
                            }
